...
public class AccountInfoController implements Initializable {
   ...
   public void ChangePassword(ActionEvent event) throws SQLException{
       ...
       PreparedStatement ps = JDBC.getConnection().prepareStatement("UPDATE users SET password = ? WHERE id ='"+UserID+"' AND password ='"+oldpass.getText()+"'");
       ps.setString(1, newpass.getText());
       int i = ps.executeUpdate();
       if(i>0){changepassconf.setText("Password Changed.");}
       else{changepassconf.setText("Wrong Password.");}
       oldpass.setText("");
       newpass.setText("");
       passretype.setText("");
